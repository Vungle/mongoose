...
Model.prototype.save = function save (fn) {
  ...
  if (this.isNew) {
    ...
    console.log("Inserting obj:"+JSON.stringify(obj));
    ...
    if (delta) {
      ...
      console.log("Updating obj:"+JSON.stringify(where)+"\n\tWith:"+JSON.stringify(delta[1]));
    } else {
      this.$__reset();
      complete(null);
    }
...
Model.prototype.remove = function remove (fn) {
  ...
  console.log("Removing Obj:"+JSON.stringify(where));
